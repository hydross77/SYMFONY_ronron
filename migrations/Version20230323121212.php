 ...
 */
final class Version20230323121212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cat (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(50) DEFAULT NULL, age VARCHAR(2) DEFAULT NULL, breed VARCHAR(50) DEFAULT NULL, tattoo VARCHAR(30) DEFAULT NULL, sterelized VARCHAR(30) DEFAULT NULL, design_coat VARCHAR(50) NOT NULL, length_coat VARCHAR(30) DEFAULT NULL, sexe VARCHAR(30) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, chip VARCHAR(255) DEFAULT NULL, INDEX IDX_9E5E43A8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cat_color (cat_id INT NOT NULL, color_id INT NOT NULL, INDEX IDX_DA2DF804E6ADA943 (cat_id), INDEX IDX_DA2DF8047ADA1FB5 (color_id), PRIMARY KEY(cat_id, color_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE color (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, announce_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, date_cat DATE NOT NULL, cp VARCHAR(255) NOT NULL, street VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526C6F5DA3DE (announce_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE donation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, date DATE NOT NULL, amount INT NOT NULL, INDEX IDX_31E581A0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cat_color ADD CONSTRAINT FK_DA2DF804E6ADA943 FOREIGN KEY (cat_id) REFERENCES cat (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cat_color ADD CONSTRAINT FK_DA2DF8047ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cat_color DROP FOREIGN KEY FK_DA2DF804E6ADA943');
        $this->addSql('ALTER TABLE cat_color DROP FOREIGN KEY FK_DA2DF8047ADA1FB5');
        ...
        $this->addSql('DROP TABLE cat_color');
